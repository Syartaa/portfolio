...
export default function Intro() {
  ...
  return (
    <section id="home" ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        <span className="font-bold">Hello, I'm Syarta.</span> I am Computer Science and Engineering student at UBT, currently gaining hands-on experience as a Flutter Developer Intern at Progtelx.
      </motion.h1>
      ...
      >
        ...
        <a className="borderBlack group flex items-center gap-2 py-3 px-7 rounded-full outline-none bg-white cursor-pointer border-black/10 transition focus:scale-110 hover:scale-110 active:scale-105 dark:bg-white/10" href="../public/Syarta_Pajaziti_CV.pdf" download>
        ...
        <div className="flex gap-3">
          <a 
            ...
            href="https://www.linkedin.com/in/syarta-pajaziti-b810a226b/" target="_blank">
              <BsLinkedin />
          </a>
          <a
